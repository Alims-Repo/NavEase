...
internal actual object DeepLinkUriUtils {
    ...
    actual fun parse(uriString: String): DeepLinkUri = ActualUri(uriString)
}

/** Copy of nonAndroid androidx.navigation.ActualUri */
private class ActualUri(private val uriString: String) : DeepLinkUri() {
