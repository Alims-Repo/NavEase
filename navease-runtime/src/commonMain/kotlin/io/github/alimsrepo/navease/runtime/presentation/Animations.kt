...
/**
 * Default slide transition used by [NavEaseNavGraph].
 *
 * All values are internal — consumers customise transitions via the [NavEaseNavGraph]
 * `transitionSpec` / `popTransitionSpec` parameters (future API).
 */
